"""
Django settings for google_docs_api project.
...
SECRET_KEY = 'django-insecure-9d3dh-+t3kto@8w2sjwpbcm7bpr1&)b98i-@0_c99tt6$(uqmh'
...
ROOT_URLCONF = 'google_docs_api.urls'
...
WSGI_APPLICATION = 'google_docs_api.wsgi.application'
